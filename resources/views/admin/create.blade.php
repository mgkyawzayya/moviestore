            ...
            <div>
                <div class="mt-0 border-gray-200 ">
                    <div class="mt-0 sm:mt-0">
                        <div class="grid grid-cols-8 gap-2 items-start border-gray-200 pt-5">
                        ...
                        <div class="mt-1 grid grid-cols-8 gap-2 sm:items-start sm:border-gray-200 sm:pt-5">
                        ...
                        <div class="mt-1 grid grid-cols-8 2 items-start border-gray-200 pt-5">
                        ...
                        @enderror
                        <div class="mt-1 sm:mt-1 grid grid-cols-8 gap-2 sm:items-start border-gray-200 pt-5">
                            <label for="code" class="block text-sm font-medium leading-5 text-gray-700 sm:mt-px sm:pt-2">
                                Code
                            </label>
                            <div class="mt-1 sm:mt-0 col-span-6">
                                <div class="max-w-xs rounded-md shadow-sm">
                        ...
                        <div class="mt-1 sm:mt-1 grid grid-cols-8 gap-2 items-start border-gray-200 pt-5">
                        ...
                        @enderror
                        <div class="mt-1 sm:mt-1 border-gray-200 pt-3">
                            <fieldset>
                                <div class="grid grid-cols-8 gap-2 items-baseline">
                                    <div>
                        ...
                        <div class="mt-1 sm:mt-1 grid grid-cols-8 gap-2 tems-start border-gray-200 pt-5">
