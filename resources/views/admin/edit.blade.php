            ...
            <div>
                <div class="mt-0 border-gray-200 ">
                    <div class="mt-0 sm:mt-0">
                        <div class="sm:grid sm:grid-cols-8 sm:gap-4 sm:items-start sm:border-gray-200 sm:pt-5">
                        ...
                        <div class="mt-1 sm:mt-1 sm:grid sm:grid-cols-8 sm:gap-4 sm:items-start sm:border-gray-200 sm:pt-5">
                        ...
                        <div class="mt-1 sm:mt-1 sm:border-gray-200 pt-3">
                            <fieldset>
                                <div class="sm:grid sm:grid-cols-8 sm:gap-4 sm:items-baseline">
                                    <div>
