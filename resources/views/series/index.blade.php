...
<div class="relative bg-black pt-6 pb-5 px-4 sm:px-6 lg:pt-10 lg:pb-2 lg:px-8">
    <div class="relative max-w-7xl mx-auto">
        <div class="grid grid-cols-3 mb-2">
            <a href="{{ url('series/year') }}" class="flex flex-col rounded shadow overflow-hidden mr-3">
            ...
            <a href="{{ url('series/category') }}" class="flex flex-col rounded shadow overflow-hidden mr-3">
            ...
            <a href="{{ url('series/country') }}" class="flex flex-col rounded shadow overflow-hidden">
                <div class="flex-auto bg-gray-800 p-4 flex flex-col justify-center">
                    <div class="flex-1 grid grid-cols-2">
                        <!-- <svg class="mr-1 h-6 w-6 text-indigo-600 group-hover:text-gray-300 group-focus:text-gray-300 transition ease-in-out duration-150" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
        ...
        <p class="text-2xl leading-5 text-center  text-white p-6 mb-2">{{ $count }} series in Series List</p>
        <div class="mt-0 grid gap-5 max-w-lg mx-auto grid-cols-2 lg:grid-cols-6 lg:max-w-none">

            @foreach( $movies as $movie)
            <a href="{{ url('/movies/detail/'. $movie->id)}}" class="flex flex-col rounded shadow overflow-hidden lg:mr-2 lg:mb-3">
